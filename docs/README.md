# Last Light – Projektdokumentation

Dieses Projekt wird schrittweise nach der Datei `Verfahrensbeschreibung_Last_Light.docx` umgesetzt.

Aktueller Stand: Vollständiger spielbarer Vertical Slice (Kampagne Tag 1–260 inkl. Finale).
