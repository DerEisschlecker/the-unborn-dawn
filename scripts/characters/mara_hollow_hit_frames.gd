# Purpose: Frame paths and timing for Dr. Mara Hollow hit reaction animation.
# Public API: atlas_path(), frame_region(), frame_duration().
# Dependencies: res://assets/characters/mara_hollow/hit/*_atlas.png
class_name MaraHollowHitFrames
extends RefCounted

const FRAME_COUNT := 98
const FRAME_PATH := "res://assets/characters/mara_hollow/hit/hit_%03d.png"
const SHOWCASE_ATLAS := "res://assets/characters/mara_hollow/hit/showcase_atlas.png"
const COMBAT_ATLAS := "res://assets/characters/mara_hollow/hit/combat_atlas.png"
