# Purpose: Frame paths and timing for the Priest hit reaction animation.
# Public API: atlas_path(), frame_region(), frame_duration().
# Dependencies: res://assets/characters/priest/hit/*_atlas.png
class_name PriestHitFrames
extends RefCounted

const FRAME_COUNT := 98
const FRAME_PATH := "res://assets/characters/priest/hit/hit_%03d.png"
const SHOWCASE_ATLAS := "res://assets/characters/priest/hit/showcase_atlas.png"
const COMBAT_ATLAS := "res://assets/characters/priest/hit/combat_atlas.png"
