# Purpose: Frame paths and timing for the Priest idle card animation loop.
# Public API: atlas_path(), frame_region(), frame_duration(), portrait_path().
# Dependencies: res://assets/characters/priest/idle/*_atlas.png
class_name PriestIdleFrames
extends RefCounted

const FRAME_COUNT := 98
const FRAME_PATH := "res://assets/characters/priest/idle/stand_%03d.png"
const SHOWCASE_ATLAS := "res://assets/characters/priest/idle/showcase_atlas.png"
const COMBAT_ATLAS := "res://assets/characters/priest/idle/combat_atlas.png"
const PORTRAIT_PATH := "res://assets/characters/priest/idle/portrait.png"
